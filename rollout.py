...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrain_path', type=str, default=r'outputs/checkpoints/waves-high/12MPI/models/topk1.pth')
    parser.add_argument('--dataset_dir', type=str, default=r'data/waves-high', help='Directory containing dataset')
